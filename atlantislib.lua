...
-- library init
	...
	writefile("ffff.ttf", game:HttpGet("https://github.com/ryanoasis/nerd-fonts/blob/master/src/unpatched-fonts/JetBrainsMono/NoLigatures/Medium/JetBrainsMonoNL-Medium.ttf"))
